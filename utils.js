...
function _formatAttachment(attachment1, attachment2) {
  ...
  switch (type) {
    ...
    case 'MessageLocation':
      ...
      const { u } = querystring.parse(url.parse(urlAttach).query)
      const { where1 } = querystring.parse(url.parse(u).query)
...
async function runEventListener(listeners, event, ...args) {
